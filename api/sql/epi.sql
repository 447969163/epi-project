...
CREATE TABLE article(
    ...
    aimg VARCHAR(50) NOT NULL COMMENT '文章/视频封面图',
...
CREATE TABLE donation(
    ...
    dname ENUM('口罩','手套','衣服','食用油','体温计','蔬菜') NOT NULL COMMENT '捐赠物品',
    dcount INT NOT NULL COMMENT '捐赠数量',
    dcompany VARCHAR(2) NOT NULL COMMENT '捐赠单位',
    dtime BIGINT NOT NULL COMMENT '捐赠时间',
    dstate ENUM('未捐献','未提交','正在审核','待取件','质量检测中','运输中','已完成') DEFAULT '未捐献' COMMENT '捐赠状态',
    uid INT NOT NULL COMMENT '用户id',
    FOREIGN KEY(uid) REFERENCES user(uid)
);
INSERT INTO donation VALUES (null,DEFAULT,'口罩','2000','箱',4564644646464,DEFAULT,1);
INSERT INTO donation VALUES (null,DEFAULT,'口罩','2000','箱',4564644646464,DEFAULT,1);
-- 区域数据表
